...
pub const THEME: Theme = Theme {
    ...
    text_secondary: Color::Rgb(154, 165, 206), // markdown: #9aa5ce
    text_dim: Color::Rgb(86, 95, 137),     // comments: #565f89

    border: Color::Rgb(65, 72, 104),       // terminal black: #414868
    border_dim: Color::Rgb(36, 40, 59),    // bg storm: #24283b
    ...
    accent_rose: Color::Rgb(247, 118, 142),   // red: #f7768e
